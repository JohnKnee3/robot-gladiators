...
var startGame = function() {
  ...
  for (var i = 0; i < enemyNames.length; i++) {
    if (playerHealth > 0) {
      ...
      // if we're not at the least enemy in the array
      if (playerHealth > 0 && i < enemyNames.length -1) {
        //ask if player wants ti use the store before the next round
...
// funcrtion to end the entire game
var endGame = function() {
//if player is still alive, player wins!
if (playerHealth > 0) {
  window.alert("Great job, you've just survived the game!  You now have a score of " + playerMoney + ".")
}
else {
...
var shop = function () {
  ...
  //use switch to carry out an acion
  switch (showOptionPrompt) {
    ...
    case "UPGRADE":
      ...
      //increase attack and decrease maoney
